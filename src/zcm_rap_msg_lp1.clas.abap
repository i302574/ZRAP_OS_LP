CLASS zcm_rap_msg_lp1 DEFINITION
  PUBLIC
  ...
  PUBLIC SECTION.
    CONSTANTS:
      BEGIN OF date_interval,
        msgid TYPE symsgid VALUE 'ZRAP_MSG_LP1',
...
CLASS zcm_rap_msg_lp1 IMPLEMENTATION.
